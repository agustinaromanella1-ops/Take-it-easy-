...
const SECCIONES: { titulo: string; puntos: string[] }[] = [
  {
    ...
    puntos: [
      ...
      'Todo lo que toca tus datos se puede deshacer, borrar un paciente incluido. Abajo aparece qué acaba de pasar y un botón para volver atrás, y se queda medio minuto: si te diste cuenta después de atender el teléfono, todavía está.',
      ...
      'El botón "Enfoque", arriba en Inicio, guarda los números del mes y deja en pantalla solo lo que sigue y la cosa pendiente. Sirve para los quince minutos entre paciente y paciente, cuando el resumen del mes no ayuda: compite. Se vuelve con "Ver todo" y la app se acuerda de cómo la dejaste.',
      'Cargar un paciente pide cuatro cosas: nombre, honorario, cada cuánto viene y el teléfono. Todo lo demás —los datos para facturar, la obra social, el color— está plegado abajo y lo completás cuando aparezca.',
      'En Ajustes podés pedir que la app te avise unos minutos antes de cada sesión. Ojo con lo que promete: ese aviso lo da la app y solo suena si está abierta. El que funciona con todo cerrado es la alarma del calendario del teléfono, que se manda con cada turno desde la Agenda.',
  ...
  },
  {
    ...
    puntos: [
      ...
      'El botón del cierre está siempre en Inicio y cambia de tono según el día: con sesiones sin resolver te dice cuántas, con el día cerrado te lo confirma, y sin nada agendado te lo dice también. En Agenda aparece para el día que estés mirando.',
    ],
  },
  {
    titulo: 'Finanzas',
    puntos: [
      'Resumen: lo facturado y lo cobrado del mes, lo que queda por cobrar y el total pendiente. Los últimos 6 meses y la calculadora de tarifa están plegados abajo: se abren cuando los necesitás y no ocupan la pantalla que mirás todos los días.',
